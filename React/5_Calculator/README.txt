...
//Thinking in react:
Building a component-based React application from a design first
involves identifying the components.
Draw a box around each distinct element, thinking about how you
can re-use repeated elements by populating them with unique data.
Find logical names for each element, which can become your
component names.
