...
function debounce(func) {
  ...
  return function (...args) { //rest parameter, which collects all arguments passed to this function into an array.
...
// The main job is still carried out by the function. It can be
